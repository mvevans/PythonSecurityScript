...
#Build base file
os.system(r'netstat -naob > C:\Windows\System32\stat.txt')
interval = 3
...
#open log
logfile = open(r'C:\Windows\System32\log.txt','w')
...
os.system(r'net user > C:\Windows\System32\user.txt')
userfile = open(r'C:\Windows\System32\user.txt','r')
...
initfile = open(r'C:\Windows\System32\stat.txt','r')
initfile.readline();
initfile.readline();
initfile.readline();
initfile.readline();
...
initfile.close();
testfile = open(r'C:\Windows\System32\test.txt','w')
...
os.system(r'reg add "HKLM\SYSTEM\CurrentControlSet\Control\Terminal Server" /v "fDenyTSConnections" /t REG_DWORD /d "1" /f')
os.system(r'reg add "HKLM\Software\Policies\Microsoft\Windows NT\Terminal Services" /v "fDenyTSConnections" /t REG_DWORD /d "1" /f')
...
while(1):
	...
	#Check Shares
	os.system(r'net share > C:\Windows\System32\share.txt')
	shrfile = open(r'C:\Windows\System32\share.txt','r')
