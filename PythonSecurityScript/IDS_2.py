...
#Build base file
os.system('netstat -naob > C:\Windows\System32\stat.txt')
interval = sys.argv[1]
...
#open log
logfile = open('C:\Windows\System32\log.txt','w')
...
os.system('net user > C:\Windows\System32\user.txt')
userfile = open('C:\Windows\System32\user.txt','r')
...
for user in users:
	...
	if user in 'Guest':
		...
		usercommand = ('net user '+user+' > C:\Windows\System32\user.txt')
...
initfile = open('C:\Windows\System32\stat.txt','r')
initfile.readline();
initfile.readline();
initfile.readline();
initfile.readline();
...
while(1):
	...
	for user in users:
		...
		usercommand = ('net user '+user+' > C:\Windows\System32\user.txt')
		os.system(usercommand)
		iuserfile = open('C:\Windows\System32\user.txt','r')
		line = iuserfile.readline()
		while 'Account active' not in line:
			line = iuserfile.readline()
		matchobj = re.search('\s+(?P<act>\w+)$',line)
